...
public class AsyncPortscan extends AsyncTask<Void, Object, Void> {
    ...
    private static long TIMEOUT_CONNECT = 1000 * 1000000;
    private static final long TIMEOUT_RW = 3 * 1000 * 1000000;
    ...
    private static final long WRITE_COOLDOWN = 200 * 1000000;
